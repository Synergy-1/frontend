...
//           });
//         }}
//         className="flex items-center gap-1  text-black text-lg font-semibold tracking-wide"
//       >
  ...
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between px-6 py-3 text-white">
      ...
      <button
        ...
        className="flex items-center gap-1 text-white text-lg font-semibold tracking-wide"
      >
        About Us <FiArrowRight />
      </button>
    </nav>
...
const Schedule = () => {
  const text = "Smart. Sustainable. Simple.";
